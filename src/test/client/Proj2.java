...
public class Proj2 implements EntryPoint,ClickHandler 
{
   ...
   public void onClick(ClickEvent e) {
      ...
      if (source == addButton) {
        ...
        String encData = URL.encode("name") + "=" +
              ...
              URL.encode("department") + "=" +
              URL.encode(deptBox.getText());
        String url = "http://localhost:3000/workers/modify";       
        postRequest(url,encData);
      }
      else if (source == deleteButton) {
         String encData = URL.encode("id") + "=" + selectedWorker.id;
        ...
        rb.sendRequest(data, new RequestCallback()
        {
           ...
           public void onResponseReceived(final Request request,
              final Response response){
                 ...
                 String url = "http://localhost:3000/workers/index.json";
                 getRequest(url);
           }
        });
      }
   ...
   private void loginRequest(String url, String data)
   {
      final RequestBuilder rb =
            new RequestBuilder(RequestBuilder.POST,url);
      rb.setHeader("Content-type",
